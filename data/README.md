...
| `swe_sota_agent/tools/` | `compute_tool_inventory.py`, `compute_workflow_replacement.py` | Source for the `line_trace`, `caller_trace`, `line_edit`, `kanban_update` tools. |
| `repo_meta/` | `compute_pipeline_inventory.py`, `compute_workflow_replacement.py` | A pruned mirror of the upstream repo: `.gitlab-ci.yml`, `scripts/module_load.sh`, `AGENTS.md`, `README.md`, `docs/`. |
