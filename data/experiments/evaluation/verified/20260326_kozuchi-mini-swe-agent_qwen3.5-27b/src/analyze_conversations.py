...
final patch. They cannot answer questions about the *internal*
linguistic and tool-use structure of the agent's conversation —
how it apportions text vs. tool calls, what shell commands it
...
totalling ~2.7 GB) and accumulate eleven feature families:
  ...
  F2  for every assistant message we split out the
      ...
      decompose linguistic effort vs. tool effort.
