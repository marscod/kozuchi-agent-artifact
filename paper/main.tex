...
%% Camera-ready rights: placeholder until the ACM rights-form email
%% arrives; update \setcopyright, \acmISBN, and \acmDOI from the form.
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=1.0\textwidth]{\figpath{overall-architecture.pdf}}
...
among strict open-weight Java submissions, and recovers \SI{80}{\percent} of resolved
...
\label{sec:artifact}
\label{sec:data}
The public review artifact, including the Kozuchi Agent source code
and all analysis, is available at
