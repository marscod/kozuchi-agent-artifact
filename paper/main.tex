...
5/500 estimated outcomes ($\le$1.0~pp), so we report the submitted pair
...
mean per-instance wall-clock is 0.95~h on the two-GPU tensor-parallel
...
call or token budget that stops the long tail (cutting at the 90\%
